...
<template>
    <div class="text-center mx-auto container">
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-center justify-center font-medium gap-5">
                <h1 class="text-3xl">Проверка тональности текста</h1>
            ...
            <select required v-model="flag"
                class="bg-primary-color fixed right-44 border-2 font-bold border-hover-color text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-50% p-2.5">
    ...
    <TonalityInformation :total-tonality="totalTonality" v-if="flag !== '' && textOfTonality.length > 0" />
